                ...
                <div className="max-w-md w-full bg-white rounded-2xl shadow-elevated p-8 relative z-10 border border-gray-100/50 my-auto">
                    {isRegistered ? (
                        <div className="text-center py-4">
                            ...
                            <p className="text-sm text-gray-600 mb-1 leading-relaxed max-w-sm mx-auto">
                                Liên kết kích hoạt đã được gửi đến địa chỉ email:
                            </p>
                            <p className="font-semibold text-primary mb-6 text-sm break-all">{registeredEmail}</p>
                            <p className="text-sm text-gray-500 mb-8 leading-relaxed max-w-sm mx-auto">
                                Vui lòng kiểm tra kỹ hòm thư (kiểm tra cả hộp thư rác / Spam nếu chưa nhận được) và bấm kích hoạt để hoàn tất tài khoản trước khi đăng nhập.
                            </p>
                            <Link
                                to="/login"
